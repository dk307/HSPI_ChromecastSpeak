...
namespace SharpCaster.Channels
{
    internal class MediaChannel : ChromecastChannelWithRequestTracking<MediaStatus>
    {
        ...
        public async Task<MediaStatus> LoadMedia(
            ...
            string streamType = StreamTypeBuffered,
            double duration = 0D,
        ...
        public const string StreamTypeBuffered = "BUFFERED";
        public const string StreamTypeLive = "LIVE";
        public const string StreamTypeOther = "OTHERs";
    }
}